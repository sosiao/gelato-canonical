...
/**
 * Provide fields which named code and value with the different type for enum.
 ...
 * @since 1.0
 */
public interface BiEnum<T extends Serializable, U extends Serializable> extends BusinessCode<T> {
